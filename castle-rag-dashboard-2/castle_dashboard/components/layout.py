...
def build_layout() -> html.Div:
    return html.Div(
        ...
        children=[
            ...
            dcc.Store(
                id="selected-keywords-store",
                data={"base_query": "", "terms": []},
            ),
            dcc.Store(id="evidence-scroll-request", data=None),
            dcc.Store(id="evidence-scroll-sink", data=0),
            ...
            dcc.Interval(id="startup-state-poll", interval=1000, n_intervals=0),
            build_search_panel(),
            html.Main(
